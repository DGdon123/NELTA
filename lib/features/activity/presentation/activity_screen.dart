...
import 'package:nelta/features/activity/presentation/activity_detail_screen.dart';
import 'package:nelta/features/activity/presentation/controllers/activitylist_controller.dart';
...
class ActivityListScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final conferenceList = ref.watch(acitivityControllerProvider);
    double screenW = MediaQuery.of(context).size.width;
    return Scaffold(
        appBar: AppBar(
          title: const Text(AppConst.kappBarActivities),
        ),
        body: AsyncValueWidget(
            ...
            providerBase: acitivityControllerProvider));
  }
}
